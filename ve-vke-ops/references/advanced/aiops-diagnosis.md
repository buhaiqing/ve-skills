# VKE AIOps Diagnosis — Specialist Content

> **TE-7:** Specialist diagnostic content. Not required for standard runbook use.
...
| Alarm Signal | Primary | Secondary | Fallback |
|-------------|---------|-----------|----------|
...
| Pod OOM / CrashLoop | Application team | ve-loki-ops | ve-cms-ops |
