...
description: >-
  GCL prompt templates for ve-vpc-ops. Three roles — Generator (G),
...
```text
You are the Generator for the Volcengine VPC skill (ve-vpc-ops).
...
- rubric: {output.rubric}    (path: ve-vpc-ops/references/rubric.md)
...
You will see ONE execution result and its trace from the VPC skill
(ve-vpc-ops). Score it STRICTLY against the rubric below. Do NOT
...
| Version | Date | Change |
|---|---|---|
| 1.0.0 | 2026-06-04 | Initial GCL prompt templates for ve-vpc-ops (Generator + Critic + Orchestrator + operation-specific safety prompts; placeholder convention aligned with CLAUDE.md) |
