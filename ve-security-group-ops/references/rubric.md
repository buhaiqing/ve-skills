...
description: >-
  GCL rubric instance for ve-security-group-ops. Use to score Generator outputs
  ...
  Destructive: DeleteSecurityGroup, RevokeSecurityGroupIngress, RevokeSecurityGroupEgress; State-changing: AuthorizeSecurityGroupIngress, AuthorizeSecurityGroupEgress, ModifySecurityGroupAttributes; Mutating: CreateSecurityGroup; Read-only: DescribeSecurityGroups, DescribeSecurityGroupAttributes, AuditSecurityGroupRules, DetectExposedPorts, FindUnusedSecurityGroups, DetectRuleConflicts
license: MIT
metadata:
  author: volcengine
  version: "1.0.0"
...
| Tier | Operations in `ve-security-group-ops` | `max_iter` | Safety floor |
|---|---|---|---|
...
| Version | Date | Change |
|---|---|---|
| 1.0.0 | 2026-06-04 | Initial GCL rubric for ve-security-group-ops (5 dimensions, 4-tier operation classification, product-specific safety + correctness + spec-compliance checks) |
