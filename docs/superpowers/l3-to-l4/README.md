...
本目录收纳 L3（条件自动执行）→ L4（自治自愈）演进相关的 Superpowers 规格（spec）与执行计划（plan），按 `specs/` 与 `plans/` 子目录组织。每个 L4 任务（T09–T16）独立拆分 spec + plan。
...
| T12 | 预测式触发源（先于告警） | [specs/2026-07-17-l4-t12-predictive-trigger-design.md](specs/2026-07-17-l4-t12-predictive-trigger-design.md) | [plans/2026-07-17-l4-t12-predictive-trigger.md](plans/2026-07-17-l4-t12-predictive-trigger.md) | ✅ DONE |

## 关联

- 任务卡（spec + plan 形态）：`docs/l3-to-l4-tasks/`
