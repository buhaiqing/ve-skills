...
description: >-
  GCL prompt templates for ve-cdn-ops. Three roles — Generator (G),
...
```text
You are the Generator for the Volcengine CDN skill (ve-cdn-ops).
...
- rubric: {{output.rubric}}    (path: ve-cdn-ops/references/rubric.md)
...
3. Execute: prefer `ve cdn <Action> --<Param> value` (PascalCase action and
...
You will see ONE execution result and its trace from the CDN skill
(ve-cdn-ops). Score it STRICTLY against the rubric below. Do NOT
...
| Version | Date | Change |
|---|---|---|
| 1.0.0 | 2026-06-04 | Initial GCL prompt templates for ve-cdn-ops (Generator + Critic + Orchestrator + operation-specific safety prompts; placeholder convention aligned with CLAUDE.md) |
