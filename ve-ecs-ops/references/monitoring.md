...
> **TE-7:** Deep AIOps content (diagnosis decision tree, alarm storm handling, proactive inspection checklist, multi-round review) → [`references/advanced/aiops.md`](advanced/aiops.md)
